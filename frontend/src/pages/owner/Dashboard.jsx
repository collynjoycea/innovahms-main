...
const MiniStat = ({ label, value, tone = "slate" }) => {
  const classes =
    tone === "gold"
      ? "border-[#bf9b30]/15 bg-[#bf9b30]/10 text-[#8f7423] dark:border-[#bf9b30]/25 dark:bg-[#bf9b30]/10 dark:text-[#f0cf75]"
      : tone === "rose"
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 xl:grid-cols-[1.3fr_0.7fr]">
          <div className="rounded-[28px] border border-slate-100 bg-white p-6 shadow-[0_18px_35px_-24px_rgba(15,23,42,0.35)] dark:border-white/10 dark:bg-[#11151d] dark:shadow-none">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              ...
              <div className="rounded-2xl border border-[#bf9b30]/15 bg-[#bf9b30]/10 px-4 py-3 text-right dark:border-[#bf9b30]/25 dark:bg-[#bf9b30]/10">
          ...
          <div className="rounded-[28px] border border-slate-100 bg-white p-6 shadow-[0_18px_35px_-24px_rgba(15,23,42,0.35)] dark:border-white/10 dark:bg-[#11151d] dark:shadow-none">
            ...
            <div className="mt-5 space-y-4">
              ...
              <div className="rounded-2xl border border-[#bf9b30]/15 bg-[linear-gradient(135deg,rgba(191,155,48,0.12),rgba(191,155,48,0.03))] p-4 dark:border-[#bf9b30]/25 dark:bg-[linear-gradient(135deg,rgba(191,155,48,0.16),rgba(191,155,48,0.04))]">
