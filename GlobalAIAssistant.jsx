...
const getDefaultWelcome = (firstName) => [
  {
    ...
    from: "bot",
    text: firstName
      ? `Hi ${firstName}. I'm your 24/7 AI assistant. Feel free to ask me anything about the hotel, your booking, or anything else. I'm here to help!`
      : "Hi! I'm your 24/7 AI assistant. Feel free to ask me anything about the hotel, your booking, or anything else. I'm here to help!",
    timestamp: Date.now(),
  },
];
